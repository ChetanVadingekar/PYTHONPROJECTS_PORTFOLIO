...
# Step 1: Writing a function that can print out a board. 
...
# Step 3: Writing a function that takes in the board list object, 
...
# Step 4: Writing a function that takes in a board and checks to see if someone has won.
...
# Step 8: Writing a function that asks for a player's next position (as a number 1-9) and
...
# Step 10: Here comes the driver code to run the game!
while True:
    # Reset the board
    theBoard = [' '] * 10 
    ...
    play_game = ("Are you ready to play? Enter Yes or NO")
